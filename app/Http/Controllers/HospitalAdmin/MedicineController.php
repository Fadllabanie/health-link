...
use App\Http\Requests\HospitalAdmin\StoreMedicineRequest;
use App\Http\Requests\HospitalAdmin\UpdateMedicineRequest;
...
class MedicineController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('hospital-admin.medicines.index', compact('medicines', 'categories'));
    }
    ...
    public function create(): View
    {
        ...
        return view('hospital-admin.medicines.create', compact('categories'));
    }
    ...
    public function store(StoreMedicineRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('hospital-admin.medicines.index')
    ...
    public function show(Medicine $medicine): View
    {
        ...
        return view('hospital-admin.medicines.show', compact('medicine'));
    }
    ...
    public function edit(Medicine $medicine): View
    {
        ...
        return view('hospital-admin.medicines.edit', compact('medicine', 'categories'));
    }
    ...
    public function update(UpdateMedicineRequest $request, Medicine $medicine): RedirectResponse
    {
        ...
        return redirect()->route('hospital-admin.medicines.show', $medicine)
