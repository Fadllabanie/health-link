    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <a href="{{ route('hospital-admin.pharmacies.inventory.show', [$pharmacy, $inventory]) }}" class="btn btn-sm btn-outline-secondary me-3">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('hospital-admin.pharmacies.inventory.update', [$pharmacy, $inventory]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <a href="{{ route('hospital-admin.pharmacies.inventory.show', [$pharmacy, $inventory]) }}" class="btn btn-outline-secondary">{{ __('app.cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
