        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('hospital-admin.pharmacies.inventory.index', $pharmacy) }}" class="btn btn-sm btn-outline-secondary">
                        <i class="bx bx-arrow-back"></i>
                    </a>
                    <h5 class="mb-0">{{ $inventory->medicine?->name ?? __('pharmacies.inventory') }}</h5>
                </div>
                <a href="{{ route('hospital-admin.pharmacies.inventory.edit', [$pharmacy, $inventory]) }}" class="btn btn-sm btn-outline-secondary">
