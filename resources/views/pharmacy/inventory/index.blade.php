...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">{{ __('pharmacies.inventory_items') }}</h5>
        <a href="{{ route('pharmacy.inventory.create') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body border-bottom pb-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('pharmacy.inventory.index') }}" class="btn btn-outline-secondary">{{ __('app.cancel') }}</a>
            </div>
        </form>
    </div>
                ...
                @forelse($items as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('pharmacy.inventory.edit', $item) }}"
