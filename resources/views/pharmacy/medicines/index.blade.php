    ...
    <div class="card-body border-bottom pb-3">
        <form method="GET" class="row g-2">
            ...
            @if(request()->hasAny(['search', 'category', 'form', 'status']))
                <div class="col-6 col-sm-auto">
                    <a href="{{ route('pharmacy.medicines.index') }}" class="btn btn-outline-danger w-100">{{ __('app.cancel') }}</a>
                </div>
            @endif
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <a href="{{ route('pharmacy.medicines.edit', $medicine) }}"
                                ...
                                <form method="POST"
                                    action="{{ route('pharmacy.medicines.destroy', $medicine) }}"
