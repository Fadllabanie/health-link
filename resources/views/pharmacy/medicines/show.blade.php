        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <a href="{{ route('pharmacy.medicines.index') }}" class="btn btn-sm btn-outline-secondary me-3">
                        <i class="bx bx-arrow-back"></i>
                    </a>
                    <h5 class="mb-0">{{ $medicine->name }}</h5>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('pharmacy.medicines.edit', $medicine) }}" class="btn btn-sm btn-primary">
                        <i class="bx bx-edit me-1"></i>{{ __('app.edit') }}
                    </a>
                    <form method="POST" action="{{ route('pharmacy.medicines.destroy', $medicine) }}"
    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-footer">
                <form method="POST"
                    action="{{ route('pharmacy.medicines.toggle-status', $medicine) }}">
                    @csrf @method('PATCH')
