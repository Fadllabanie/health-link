...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0">تعديل: {{ $specialty->name }}</h4>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('super-admin.master-data.specialties.update', $specialty) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
